...
export const metadata: Metadata = {
  title: "Terms of Use - Partnerz.ai",
  description: "Terms of Use for Partnerz.ai",
};
    ...
    <div className="min-h-screen bg-black text-zinc-300">
      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="space-y-12 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">1. General</h2>
            <div className="space-y-4">
              <p>
                <span className="font-bold text-white">a. Parties.</span> This Agreement is between Partnerz.ai (“Company,” “us,” “our,” or “we”) and either (i) the User (as hereinafter defined), or (ii) if the User is acting as an authorized representative of a legal entity, then that legal entity (in either case, the “you” or “your”), and applies to your access to, and use of, the Website, so please read it carefully. This Agreement does not alter in any way the terms or conditions of any other agreement you may have with the Company or its Affiliates for services, products or otherwise.
              </p>
              
              <div>
                <span className="font-bold text-white">b. Definitions</span>
                <ul className="list-none pl-4 mt-2 space-y-2">
                  <li>i. “Affiliate” means any entity that now or hereafter (A) directly or indirectly owns or controls, is owned or controlled by, or is under common ownership or control with Company, and (B), for Company, is under common management with a given party.</li>
                  <li>ii. “Personal Information” means any information that identifies or relates to an individual or can be used in conjunction with other information to identify an individual, whether such information is explicitly regulated by applicable law or otherwise.</li>
                  <li>iii. “Service Provider(s)” means third-party service providers, vendors, and contractors who provide services to us or on our behalf in support of the Website and our rights under this Agreement.</li>
                  <li>iv. “User” means anyone who accesses the Website.</li>
                </ul>
              </div>

              <div>
                <span className="font-bold text-white">c. Changes to Agreement and Website by Company</span>
                <ul className="list-none pl-4 mt-2 space-y-2">
                  <li>i. We reserve the right to change or modify this Agreement and the Website, at any time. If we decide to change the Agreement, we will post a new version on the Website and update the date. The changes will apply to all access to and use of the Website by you thereafter. Any changes or modifications will be effective immediately upon posting of the revisions on the Website, and you waive any right you may have to receive specific notice of such changes or modifications. As previously stated, it is your responsibility to read this Agreement each time you access or use the Website. Notwithstanding the foregoing, any changes to the dispute resolution or law and venue provisions set out in Section 14 “Dispute Resolution” and Section 15(a) “Applicable Law and Venue,” respectively, shall not apply to any disputes for which the parties have actual notice on or before the date the change is posted on the Website.</li>
                  <li>ii. YOUR USE OF THE WEBSITE FOLLOWING THE POSTING OF CHANGES OR MODIFICATIONS TO THE AGREEMENT WILL CONSTITUTE YOUR ACCEPTANCE OF THE REVISED AGREEMENT. IF YOU DO NOT AGREE TO THE AMENDED TERMS, YOU MUST IMMEDIATELY STOP USING THE WEBSITE.</li>
                  <li>iii. The specific features and functionality of the Website are dynamic and may change from time to time. We reserve complete and sole discretion with respect to the operation of the Website. We also reserve the right to withdraw, suspend, or discontinue any functionality or feature of the Website at any time.</li>
                </ul>
              </div>

              <p>
                <span className="font-bold text-white">d. Use of the Website by Minors.</span> The Website is not intended or authorized for use by persons under the age of eighteen (18). If we believe that you are under the age of eighteen (18) or that you are not old enough to consent to and be legally bound by this Agreement, we may, at any time, in our sole discretion, and with or without notice: (i) terminate your access to or use of the Website (or any portion, aspect, or feature thereof), or (ii) delete any content or information that you have posted through the Website.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-4">2. Privacy</h2>
            <div className="space-y-4">
              <p>
                <span className="font-bold text-white">a. Generally.</span> We believe strongly in providing you notice of how we collect and use your data collected from the Website, which includes Personal Information. Our Privacy Policy, located at /privacy, describes how we will collect, use, share, or otherwise process the Personal Information we will collect from you and further provides any opt-out mechanisms available to you. You hereby acknowledge that you have read our Privacy Policy and give your consent for us to collect, use, share, or otherwise process your Personal Information in accordance with our Privacy Policy. Please note that per the terms of the Privacy Policy, the Privacy Policy may be changed from time to time and is effective immediately upon posting such changes to the Website.
              </p>
              
              <div>
                <span className="font-bold text-white">b. Consent to be Contacted via Phone, Email, Text, or Mail.</span>
                <ul className="list-none pl-4 mt-2 space-y-2">
                  <li>i. By filling out any forms on the Website, providing information to us, or making any inquiry to us, you acknowledge that we have an established business relationship, and you give your express consent for us or our Service Providers to contact you, on our behalf, by phone, mobile phone, email, mail, or text.</li>
                  <li>ii. By agreeing to receive SMS marketing communication on the SMS opt-in form, you expressly consent to receive marketing text messages from the us or one of our Service Providers at the mobile number you provide. You may opt-out of SMS marketing communication by replying STOP to any text message from us or one of our Service Providers. Consent to SMS marketing communications is not required to access the Website as a User. No purchase is required in order to receive marketing messages. Messaging and data rates may apply.</li>
                </ul>
              </div>

              <p>
                <span className="font-bold text-white">c. Consent to Share Personal Information with Affiliates.</span> By accessing and using this Website, you provide your consent for us to share your Personal Information you provide to us through the Website with our Affiliates for various purposes as specifically identified in the Privacy Policy. Take note that the Privacy Policy provides notice of additional instances where we share or otherwise disclose your Personal Information to third parties.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-4">3. Technical Requirements</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">4. Proprietary Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">5. Use Rights and Restrictions</h2>
            <div className="space-y-4">
              <p>
                <span className="font-bold text-white">a. Permitted Use.</span> Subject to the terms of this Agreement, you are granted a limited, personal, non-exclusive, non-sublicensable, non-assignable, non-transferable, and revocable license to access and use the Website and all materials available on or through the Website (“Website Materials”) solely for your own personal use in accordance with the license scope and use restrictions specified in this Agreement and any other applicable agreement between you and us.
              </p>
              
              <div>
                <span className="font-bold text-white">b. Restrictions.</span>
                <ul className="list-none pl-4 mt-2 space-y-2">
                  <li>i. You may not use the Website or any Website Materials for your own commercial purposes.</li>
                  <li>ii. You agree not to use the Website or Website Materials for any unintended purpose, for any unlawful purpose, or in any way that might harm, damage, or disparage any other party, including the Company, its Affiliates, and all of its suppliers.</li>
                  <li>iii. Without limiting the preceding sub-sections (i) and (ii), you agree that you will not do, or attempt to do, any of the following, unless expressly authorized by us to do so: (A) alter or modify the Website, or make any electronic reproduction, adaptation, distribution, performance, or display of the Website, or any portion thereof, except to the extent permitted by the intent and functionality of the Website or as required for the limited purpose of reviewing material on or interacting with the Website for the intended purpose of the Website; (B) sell, rent, lease, transfer, distribute, or assign to any third party any rights to the Website or related materials; (C) remove or modify any proprietary notice or labels on the Website, or related materials, including author attribution and copyright notices, or use any of our trademarks as meta-tags on any other website or application; (D) use the Website for comparative or competitive research purposes; (E) copy, modify, or erase any information contained on computer servers used or controlled by us or any third party except to the extent permitted by the intent and functionality of the Website; (F) use the Website to violate any legal right of Company or any third party, including any publicity or privacy right, copyright, or other intellectual property right, or to take any action that is harassing, libelous, defamatory, abusive, tortious, threatening, harmful, or otherwise objectionable; (G) access or use any password-protected, secure, or non-public areas of the Website, or access data on the Website, not intended for you, except as specifically authorized in writing by us; (H) impersonate or misrepresent your affiliation with any person or entity, including the Company, or allow a third party to use your identification or to pretend to be you; (I) use any automated means (including screen and database scraping, spiders, robots, crawlers, bypassing “captcha” or similar precautions, and any other automated activity with the purpose of obtaining information from the Website) to access or use the Website, or display the Website, or portions thereof (e.g., deep linking, framing, scraping, etc.), without our express written permission; (J) attempt to or actually disrupt, impair, or interfere with the Website or any information, data, or materials posted or displayed by us; (K) attempt to probe, scan, or test the vulnerability of the Website or breach any implemented security or authentication measures, regardless of your motives or intent; (L) attempt to interfere with or disrupt access to or use of the Website by any User, processor, host, or network, including, without limitation, by submitting a virus, worm, Trojan horse, or other malicious code; (M) post any content to the Website that: (1) includes any profane, obscene, defamatory, discriminatory, threatening, menacing, harassing, or violent content; (2) depicts or suggests nudity or sexual acts; (3) promotes hatred, including against members of a protected group under federal, state, or local law (such as, for example, a group defined by race, gender, or national origin); (4) is objectively shocking or disgusting; (5) depicts or suggests presently occurring illegal activity; (6) includes unlicensed proprietary content of a third party, including, e.g., third-party content protected by copyright or trademark for which you do not have a license; (7) breaches any duty of confidentiality you may have to a third party (e.g., discloses private information about a third party without consent); or (8) is contrary to the Company’s mission; or (N) use the Website in any manner whatsoever that could lead to a violation of any federal, state, or local laws, rules, or regulations.</li>
                  <li>iv. The User may provide links to the Website provided that portions of the Website are not removed or obscured, the link is to a website that does not engage in illegal or pornographic activities, and the link is immediately discontinued upon request by Company.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-4">13. International Use</h2>
            <p>
