    ...
    <div className="flex h-[calc(100vh-8rem)] gap-6">
            ...
            <div key={i} className="flex items-center gap-3 rounded-lg p-3 hover:bg-white/5 cursor-pointer">
              ...
              <div className="flex-1 overflow-hidden">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-white">Partner {i}</span>
                  <span className="text-xs text-zinc-500">12:30</span>
                </div>
                <p className="truncate text-sm text-zinc-400">Hey, let's discuss the commission...</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <Card className="flex-1 border-white/10 bg-white/5 backdrop-blur flex flex-col">
        <div className="p-4 border-b border-white/10 flex items-center gap-3">
          <div className="h-10 w-10 rounded-full bg-zinc-800" />
          <div>
            <h3 className="font-semibold text-white">Partner 1</h3>
        ...
        <div className="flex-1 p-4 space-y-4 overflow-y-auto">
          <div className="flex justify-end">
            <div className="rounded-lg bg-primary px-4 py-2 text-white max-w-[80%]">
              Hi! I'm interested in your affiliate program.
            </div>
          </div>
          <div className="flex justify-start">
            <div className="rounded-lg bg-zinc-800 px-4 py-2 text-white max-w-[80%]">
              Great! Let's discuss the details. What kind of audience do you have?
            </div>
          </div>
        </div>
