        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-8">
                 ...
                 <div className="flex flex-col gap-3">
                    <label className="text-lg font-semibold text-white">Company Logo</label>
                    <ImageUploadWithCrop 
                 ...
                 <div className="flex flex-col gap-8">
                    <div className="space-y-3">
                        <label className="text-lg font-semibold text-white">Company Name</label>
                     ...
                     <div className="space-y-3">
                        <label className="text-lg font-semibold text-white">Website URL</label>
                    ...
                    <div className="space-y-3">
                        <label className="text-lg font-semibold text-white">Headline (Short Description)</label>
                     ...
                     <div className="space-y-3">
                      <label className="text-lg font-semibold text-white">Long Description</label>
                    ...
                    <div className="space-y-3">
                        <label className="text-lg font-semibold text-white">Year Founded</label>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-8">
                 <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Commission Model</label>
                ...
                <div className="space-y-3">
                   <label className="text-lg font-semibold text-white">Commission Rate (%)</label>
                 ...
                 <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Cookie Duration (Days)</label>
                ...
                <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Tracking Method</label>
                 ...
                 <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Recommended Landing Page URL</label>
                ...
                <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Exclusive Deal for Partners</label>
             ...
             <div className="space-y-6">
              ...
              <div className="flex flex-col gap-8">
                 <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Technical Contact (Email)</label>
                ...
                <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Geo Restrictions</label>
                 ...
                 <div className="space-y-3">
                    <label className="text-lg font-semibold text-white">Supported Languages</label>
